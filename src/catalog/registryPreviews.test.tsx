 ...
 *      mockup-coupled — 30 today) has exactly one registry entry, that
 ...
 *      content for every one of the 30 slugs.
 *
...
describe('registry ↔ manifest visual contract (parametrized)', () => {
  it('the manifest carries 30 visual entries and they all have detail-page content fields', () => {
    // Guard rail for the "30" in the task: if metadata work (R2+) changes
    // classifications, this fails loudly instead of silently re-scoping.
    expect(visualEntries).toHaveLength(30)
