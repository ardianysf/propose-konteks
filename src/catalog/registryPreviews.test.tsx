 ...
 *      mockup-coupled — 29 today) has exactly one registry entry, that
 ...
 *      content for every one of the 29 slugs.
 *
...
describe('registry ↔ manifest visual contract (parametrized)', () => {
  it('the manifest carries 29 visual entries and they all have detail-page content fields', () => {
    // Guard rail for the "29" in the task: if metadata work (R2+) changes
    // classifications, this fails loudly instead of silently re-scoping.
    expect(visualEntries).toHaveLength(29)
